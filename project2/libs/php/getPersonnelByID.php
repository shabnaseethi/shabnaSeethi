<?php
	...
	$query = $conn->prepare('SELECT location.id as locationID,department.id as departmentID, department.name as department,location.name as location from department INNER JOIN location on department.id=? AND department.locationID = location.id');
